...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B9lUqUCL.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 max-w-xs rounded-md bg-fg px-2.5 py-1.5 text-xs text-accent-fg shadow-sm", className),
	...props
}) }));
...
function AuthProvider({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
		...
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
			...
			toastOptions: { className: "bg-surface text-fg shadow-[var(--shadow-border)]" }
		})]
	});
}
...
var styles_default = "/assets/styles-5BUs1mSP.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Trash Talking Parrot for the Tow Path — a cheeky canal-side Furby puppet."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Lbuz8_Nv.mjs");
