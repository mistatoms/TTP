...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CFiqQwvr.mjs");
...
var manifest = {
	"3978122c8f0c0060ae36341090f9dc6f840e3f8f42b7fab57bf91c7559961e7b": {
		functionName: "createVoiceClientSecret_createServerFn_handler",
		importer: () => import("./voice-DgWEZM_y.mjs")
	},
	"a4112c2d35ceac63298168a200e4aca8b03490dc3f9c62f7bcba13839620dc5c": {
		functionName: "checkAiAvailable_createServerFn_handler",
		importer: () => import("./voice-DgWEZM_y.mjs")
	},
	"de7890637ee15f7c3f989b0df5a4d232434d51ee4d7bb02b1739a99da5a0160e": {
		functionName: "synthesizeSpeech_createServerFn_handler",
		importer: () => import("./voice-DgWEZM_y.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DqX6W2IN.mjs").then((n) => n.t),
