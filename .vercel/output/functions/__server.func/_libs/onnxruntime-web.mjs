...
import { a as TRACE_FUNC_BEGIN, c as env, i as TRACE_EVENT_END, l as registerBackend, n as TRACE, o as TRACE_FUNC_END, r as TRACE_EVENT_BEGIN, s as Tensor, t as InferenceSession } from "./onnxruntime-common.mjs";
...
var de = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof require < "u" ? require : t)[n] }) : e)(function(e) {
...
var me = C(() => {
	...
	Ae = j || typeof location > "u" ? void 0 : location.origin, Lt = import.meta.url > "file:" && import.meta.url < "file;", Bt = () => {
		if (!j) {
			if (Lt) return new URL(new URL("ort.node.min.mjs", import.meta.url).href, Ae).href;
